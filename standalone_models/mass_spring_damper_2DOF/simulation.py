...
# model imports
from numenv.python.src import mass_spring_damper_2DOF

# Creating the numerical model from the imported script
num_model  = multibody_system(mass_spring_damper_2DOF)
...
num_config.construct_from_json('symenv/mass_spring_damper_2DOF_cfg.json')
