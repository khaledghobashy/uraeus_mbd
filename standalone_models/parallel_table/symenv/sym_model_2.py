...
sym_model.add_joint.spherical('h1', 'rbs_l1', 'rbs_l7')
sym_model.add_joint.cylinderical('k1', 'rbs_l2', 'rbs_l7')
sym_model.add_joint.spherical('l1', 'rbs_l3', 'rbs_l8')

sym_model.add_joint.cylinderical('h2', 'rbs_l4', 'rbs_l7')
sym_model.add_joint.revolute('k2', 'rbs_l5', 'rbs_l7')
sym_model.add_joint.revolute('l2', 'rbs_l6', 'rbs_l8')

sym_model.add_joint.spherical('d', 'rbs_table', 'rbs_l4')
sym_model.add_joint.cylinderical('e', 'rbs_table', 'rbs_l5')
sym_model.add_joint.spherical('f', 'rbs_table', 'rbs_l6')

sym_model.add_joint.translational('trans', 'rbs_l7', 'rbs_l8')
...
sym_config.add_point.UserInput('p8')
sym_config.add_point.UserInput('p9')
...
# Revolute Joint (a) location and orientation
sym_config.add_relation.Equal_to('pt1_jcs_d', ('hps_p7',))
sym_config.add_relation.Equal_to('ax1_jcs_d', ('vcs_x',))

# Revolute Joint (b) location and orientation
sym_config.add_relation.Equal_to('pt1_jcs_e', ('hps_p8',))
sym_config.add_relation.Equal_to('ax1_jcs_e', ('vcs_x',))

# Revolute Joint (c) location and orientation
sym_config.add_relation.Equal_to('pt1_jcs_f', ('hps_p9',))
...
# Revolute Joint (a) location and orientation
sym_config.add_relation.Equal_to('pt1_jcs_h2', ('hps_p4',))
sym_config.add_relation.Equal_to('ax1_jcs_h2', ('vcs_x',))

# Revolute Joint (a) location and orientation
sym_config.add_relation.Equal_to('pt1_jcs_k2', ('hps_p5',))
sym_config.add_relation.Equal_to('ax1_jcs_k2', ('vcs_x',))

# Revolute Joint (a) location and orientation
sym_config.add_relation.Equal_to('pt1_jcs_l2', ('hps_p6',))
sym_config.add_relation.Equal_to('ax1_jcs_l2', ('vcs_x',))
...
sym_config.add_geometry.Cylinder_Geometry('l4', ('hps_p4', 'hps_p7', 's_radius'))
sym_config.assign_geometry_to_body('rbs_l4', 'gms_l4')

sym_config.add_geometry.Cylinder_Geometry('l5', ('hps_p5', 'hps_p8', 's_radius'))
sym_config.assign_geometry_to_body('rbs_l5', 'gms_l5')

sym_config.add_geometry.Cylinder_Geometry('l6', ('hps_p6', 'hps_p9', 's_radius'))
sym_config.assign_geometry_to_body('rbs_l6', 'gms_l6')
...
sym_config.add_geometry.Cylinder_Geometry('table', ('hps_p7', 'hps_p9', 's_radius'))
